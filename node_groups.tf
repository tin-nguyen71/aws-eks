...
module "fargate_profile" {
  ...
  for_each = { for k, v in var.fargate_profiles : k => v if local.create }
  ...
  subnet_ids        = try(each.value.subnet_ids, var.fargate_profile_defaults.subnet_ids, local.subnet_ids)
  ...
  iam_role_use_name_prefix      = try(each.value.iam_role_use_name_prefix, var.fargate_profile_defaults.iam_role_use_name_prefix, false)
...
module "eks_managed_node_group" {
  ...
  for_each = { for k, v in var.eks_managed_node_groups : k => v if local.create }
  ...
  # EKS Managed Node Group
  name            = try(each.value.name, format("%s-%s", aws_eks_cluster.this[0].name, each.key))
  ...
  launch_template_name            = try(each.value.launch_template_name, var.eks_managed_node_group_defaults.launch_template_name, format("%s-%s", aws_eks_cluster.this[0].name, each.key))
  launch_template_use_name_prefix = try(each.value.launch_template_use_name_prefix, var.eks_managed_node_group_defaults.launch_template_use_name_prefix, false)
  ...
  iam_role_use_name_prefix      = try(each.value.iam_role_use_name_prefix, var.eks_managed_node_group_defaults.iam_role_use_name_prefix, false)
  ...
  security_group_use_name_prefix    = try(each.value.security_group_use_name_prefix, var.eks_managed_node_group_defaults.security_group_use_name_prefix, false)
...
module "self_managed_node_group" {
  ...
  subnet_ids         = try(each.value.subnet_ids, var.self_managed_node_group_defaults.subnet_ids, local.subnet_ids)
  ...
  iam_role_use_name_prefix      = try(each.value.iam_role_use_name_prefix, var.self_managed_node_group_defaults.iam_role_use_name_prefix, false)
  ...
  security_group_use_name_prefix    = try(each.value.security_group_use_name_prefix, var.self_managed_node_group_defaults.security_group_use_name_prefix, false)
